        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <p className="text-white/60 text-sm">
              &copy; {currentYear} Naman Portfolio. All rights reserved.
            </p>
          </div>
          
          <div className="flex space-x-6">
            <a 
              href="https://github.com/namandhounchak" 
              target="_blank" 
            ...
            <a 
              href="https://www.linkedin.com/in/naman-dhounchak-500046346/" 
              target="_blank" 
              rel="noopener noreferrer"
            ...
            <a 
              href="mailto:dhounchaknaman@gmail.com" 
              className="text-white/60 hover:text-neonblue transition-colors"
              aria-label="Email"
            >
              <Mail size={20} />
