...
const Contact = () => {
  ...
  const onSubmit = async (event: React.FormEvent) => {
    ...
    formDataToSend.append("access_key", "ccafbeff-5f3f-4cd6-8ce0-f13a5b11b7de");
          ...
          <div className="space-y-8">
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="mailto:dhounchaknaman@gmail.com" className="text-white/70 hover:text-neonblue transition-colors">
                  dhounchaknaman@gmail.com
                </a>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <a href="tel:+91 9315344002" className="text-white/70 hover:text-neonpurple transition-colors">
                  +91 9315344002
                </a>
              </div>
            </div>
